...
class RolesApi:
    ...
    async def list(self, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, assignable_scope: Optional[str] = None, timeout: Optional[float] = None) -> List[Role]:
        """
