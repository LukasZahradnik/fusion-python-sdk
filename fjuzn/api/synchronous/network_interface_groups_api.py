...
class NetworkInterfaceGroupsApi:
    ...
    def delete(self, region_name: str, availability_zone_name: str, network_interface_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> None:
        """
