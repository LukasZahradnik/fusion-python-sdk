...
class ArraysApi:
    ...
    def delete(self, region_name: str, availability_zone_name: str, array_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> ArrayRef:
        """
    ...
    def get_performance(self, region_name: str, availability_zone_name: str, array_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> Performance:
        """
    ...
    def get_space(self, region_name: str, availability_zone_name: str, array_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> Space:
        """
        (Provider) Gets performance metrics of a specific Array.  # noqa: E501
    ...
    def get(self, region_name: str, availability_zone_name: str, array_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> Array:
        """
        (Provider) Gets a specific Array.  # noqa: E501
    ...
    def list(self, region_name: str, availability_zone_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> ArrayList:
        """
