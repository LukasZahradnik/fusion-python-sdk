...
class NetworkInterfacesApi:
    ...
    def get_by_id(self, network_interface_id: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> NetworkInterface:
        """
    ...
    def get(self, region_name: str, availability_zone_name: str, array_name: str, net_intf_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> NetworkInterface:
        """
        (Provider) Gets a specific Network Interface.  # noqa: E501
