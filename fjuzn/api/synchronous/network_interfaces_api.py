...
class NetworkInterfacesApi:
    ...
    def get_e_by_id(self, network_interface_id: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> NetworkInterface:
        """
    ...
    def get_e(self, region_name: str, availability_zone_name: str, array_name: str, net_intf_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> NetworkInterface:
        """
        (Provider) Gets a specific Network Interface.  # noqa: E501
    ...
    def list(self, region_name: str, availability_zone_name: str, array_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> NetworkInterfaceList:
        """
    ...
    def update_e(self, network_interfac: NetworkInterfacePatch, region_name: str, availability_zone_name: str, array_name: str, net_intf_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> NetworkInterfacRef:
        """
        ...
        url = url.replace("{array_name}", quote(str(array_name), safe=""))
        url = url.replace("{net_intf_name}", quote(str(net_intf_name), safe=""))
        response = self.__client.patch(url, query_params, header_params, network_interfac, timeout=timeout)
