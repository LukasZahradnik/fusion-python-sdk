...
class PlacementGroupsApi:
    ...
    def create(self, placement_group: PlacementGroupPost, tenant_name: str, tenant_space_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> PlacementGroupRef:
        """
        ...
        response = self.__client.post(url, query_params, header_params, placement_group, timeout=timeout)
        
        return PlacementGroupRef(**response)

    def delete(self, tenant_name: str, tenant_space_name: str, placement_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> PlacementGroupRef:
        """
    ...
    def get_by_id(self, placement_group_id: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> PlacementGroup:
        """
    ...
    def get_sessions(self, tenant_name: str, tenant_space_name: str, placement_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> SessionList:
        """
    ...
    def get(self, tenant_name: str, tenant_space_name: str, placement_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> PlacementGroup:
        """
        Gets a specific Placement Group.  # noqa: E501
    ...
    def get_performance(self, tenant_name: str, tenant_space_name: str, placement_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> Performance:
        """
    ...
    def get_space(self, tenant_name: str, tenant_space_name: str, placement_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> Space:
        """
    ...
    def update(self, placement_group: PlacementGroupPatch, tenant_name: str, tenant_space_name: str, placement_group_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> PlacementGroupRef:
        """
        ...
        url = url.replace("{tenant_space_name}", quote(str(tenant_space_name), safe=""))
        url = url.replace("{placement_group_name}", quote(str(placement_group_name), safe=""))
        response = self.__client.patch(url, query_params, header_params, placement_group, timeout=timeout)
