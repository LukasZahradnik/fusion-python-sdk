...
class VolumeSnapshotsApi:
    ...
    def get_by_id(self, volume_snapshot_id: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> VolumeSnapshot:
        """
    ...
    def get(self, tenant_name: str, tenant_space_name: str, snapshot_name: str, volume_snapshot_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> VolumeSnapshot:
        """
        Gets a specific Volume Snapshot.  # noqa: E501
