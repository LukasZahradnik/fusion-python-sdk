...
class RoleAssignmentsApi:
    ...
    def delete(self, role_name: str, role_assignment_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> RoleAssignmentRef:
        """
    ...
    def get(self, role_name: str, role_assignment_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> RoleAssignment:
        """
        Gets a specific Role Assignment.  # noqa: E501
    ...
    def list_canonical(self, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, scope: Optional[str] = None, principal: Optional[str] = None, role: Optional[str] = None, timeout: Optional[float] = None) -> List[RoleAssignment]:
        """
    ...
    def list(self, role_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, scope: Optional[str] = None, principal: Optional[str] = None, timeout: Optional[float] = None) -> List[RoleAssignment]:
        """
        Gets a list of all Role Assignments.  # noqa: E501
