...
class StorageClassesApi:
    ...
    def delete(self, storage_service_name: str, storage_class_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> None:
        """
    ...
    def get(self, storage_service_name: str, storage_class_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> StorageClass:
        """
        Gets a specific Storage Class.  # noqa: E501
    ...
    def list(self, storage_service_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> StorageClassList:
        """
