...
class SnapshotsApi:
    ...
    def delete(self, tenant_name: str, tenant_space_name: str, snapshot_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> None:
        """
    ...
    def get(self, tenant_name: str, tenant_space_name: str, snapshot_name: str, *, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> Snapshot:
        """
        Gets a specific Snapshot.  # noqa: E501
    ...
    def query(self, *, filter: Optional[str] = None, sort: Optional[str] = None, limit: Optional[int] = None, offset: Optional[int] = None, id: Optional[str] = None, name: Optional[str] = None, display_name: Optional[str] = None, tenant_space_id: Optional[str] = None, tenant_id: Optional[str] = None, protection_policy_id: Optional[str] = None, destroyed: Optional[bool] = None, time_remaining: Optional[int] = None, x_request_id: Optional[str] = None, authorization: Optional[str] = None, x_correlation_id: Optional[str] = None, timeout: Optional[float] = None) -> SnapshotList:
        """
